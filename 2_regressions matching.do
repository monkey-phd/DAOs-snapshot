...
forvalues i = 0(50)250 { 
	...
	*/
	...
	cem  ///
	prps_choices_bin (#1) ///
	prps_rel_quorum (0 0.05 0.1 0.2 0.35) ///
	prps_link (0.5) ///
	prps_stub (0.5) ///	
	topic_1 (#5) topic_2 (#5) topic_3 (#5) topic_4 (#5) ///
	topic_5 (#5) topic_6 (#5) topic_7 (#5) topic_8 (#5) ///
	topic_9 (#5) topic_10 (#5) topic_11 (#5) topic_12 (#5) ///
	topic_13 (#5) topic_14 (#5) topic_15 (#5) topic_16 (#5) ///
	topic_17 (#5) topic_18 (#5) topic_19 (#5) ///
