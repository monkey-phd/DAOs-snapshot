...
reghdfe  voting_6m ///
	...
	relative_voting_power_act if end_6m == 0 & own_choice_tied == 0 & space_id >= 0 & space_id < 20, /// dao_cluster 1,2,3
...
reghdfe voting_6m ///
	...
	topic_9 topic_10 topic_11 topic_12 topic_13 topic_14 topic_15 topic_16 ///
	topic_17 topic_18 topic_19 ///
	relative_voting_power_act if end_6m == 0 & own_choice_tied == 0 & space_id >= 20 & space_id < 57, /// dao_cluster 1,2,3
...
reghdfe voting_6m ///
	...
	topic_9 topic_10 topic_11 topic_12 topic_13 topic_14 topic_15 topic_16 ///
	topic_17 topic_18 topic_19 ///
	relative_voting_power_act if end_6m == 0 & own_choice_tied == 0 & space_id >= 58 & space_id < 109, /// dao_cluster 1,2,3
	absorb(voter_id year_month_num) vce(cluster voter_space_id)	
...
reghdfe voting_6m ///
	...
	topic_9 topic_10 topic_11 topic_12 topic_13 topic_14 topic_15 topic_16 ///
	topic_17 topic_18 topic_19 ///
	relative_voting_power_act if end_6m == 0 & own_choice_tied == 0 & space_id >= 110 & space_id < 180, /// dao_cluster 1,2,3
	absorb(voter_id year_month_num) vce(cluster voter_space_id)	
...
reghdfe voting_6m ///
	...
	topic_9 topic_10 topic_11 topic_12 topic_13 topic_14 topic_15 topic_16 ///
	topic_17 topic_18 topic_19 ///
	relative_voting_power_act if end_6m == 0 & own_choice_tied == 0 & space_id >= 180 & space_id < 225, /// dao_cluster 1,2,3
	absorb(voter_id year_month_num) vce(cluster voter_space_id)	
